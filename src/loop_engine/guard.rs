...
impl LoopGuard {
    pub fn new(max_history: usize, repetition_threshold: usize, max_consecutive_errors: usize) -> Self {
        Self {
...
mod tests {
    ...
    #[test]
    fn test_loop_guard_repetition_detection() {
        let mut guard = LoopGuard::new(5, 3, 5);
    ...
    fn test_loop_guard_circuit_breaker() {
        let mut guard = LoopGuard::new(5, 3, 3);
